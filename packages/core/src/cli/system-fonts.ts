...
/**
 * Reading and writing the user's installed fonts.
 *
...
/** Font families the OS exposes, lowercased for comparison. */
...
/** Install font files for the current user. Idempotent. */
